...
// if we used arrow for constructor , the console will not read it as a constructor .
...
// invoked the object that calls the function that is (joe)
// 2. What is "this" when joe.scopeArrow() is invoked?
// invoked the owner of this function or this this that is (window)
// 3. Explain why "this" is different when an arrow function is used.
// because when we use this key in the arrow function it will be pointing in the owner of this function that's window 
